        ...
        try {
            ...
            if (!error) {
                if (result == "1") {
                    ...
                    console.log("Error: you must be on the Mainnet to use this website.");
					web3 = new Web3(new Web3.providers.HttpProvider("https://mainnet.infura.io/v3/f423492af8504d94979d522c3fbf3794"));//("https://testnet.infura.io/v3/f423492af8504d94979d522c3fbf3794"));
					modal2.style.display = "block";
                }
            }
        });
